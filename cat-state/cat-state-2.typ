...
[
  ...
  $ ket(alpha) = e^(-1/2abs(alpha)^2)sum_(n=0)^oo alpha^n/sqrt(n!)ket(n)
  ...
  We thus denote the normalized even and odd cat states as follows: $ #cat_plus = 1/sqrt(2(1+e^(-2abs(alpha)^2)))(ket(alpha)+ket(-alpha))","
  ...
  $ ket(0)_c &:= (#cat_plus + #cat_minus)/sqrt(2)\ &= ket(alpha) + cal(O)(e^(-2abs(alpha)^2))","
